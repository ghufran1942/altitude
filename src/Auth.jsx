...
/* Sign-in gate. On success, Root's onAuthStateChange takes over.
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.ink, fontFamily: font,
      ...
      <div style={{ width: "100%", maxWidth: 380 }}>
        <div style={{ fontFamily: "'Archivo', sans-serif", fontWeight: 800, fontSize: 32, letterSpacing: "-0.02em", marginBottom: 22 }}>
          ALTITUDE
        </div>
